...
- Post-create step (inline) `cd /app`, upgrades pip/setuptools/wheel, installs `uv`, then installs project deps from `docker/pyproject.toml` (dev extras) using `python3 -m pip`
