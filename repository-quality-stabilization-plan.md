...
- `uv run mypy api core`: 609 errors in 67 of 192 production source files after
  the settings/configuration batch. Lint and annotation modernization initially
